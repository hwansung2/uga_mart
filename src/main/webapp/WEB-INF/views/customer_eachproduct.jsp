...
$(function(){
	...
	$(".each_review_write").click(function(){
		var str = "<div class='modal'><div class='review_main'><div class = 'review_x'><img src = 'resources/img/Allshares/x.png'/></div>"
				+ "<div class = 'review_write'>리뷰 작성</div>"
				+ "<div style = 'text-align:right;'><select class = 'review_rating'>"
				+ "<option>별점</option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>"
				+ "</select></div>"
				+ "<textarea class='review_writing_customor' placeholder='솔직한 후기는 주문을 고민하는 분들에게 큰 도움이 됩니다. 허위 리뷰나 욕설, 비방이 포함되지 않게 주의해서 작성해주세요.(1,000자 이내)'></textarea>"
				+ "<div  class= 'review_savediv'><button class= 'review_save'>저장하기</button></div></div>";
			...
			<div class= "eachright_text">
				...
				<div class="each_option">
					<ul>
						...
						<li><div class='eachproduct_div'>라이더</div><span class = 'eachtext_moreinfor'>배달시간 10~20분 소요</span></li>
		...
		<div class = 'each_detail_infor'>
			<div class = 'each_detail_maindiv'>
				...
				<div class = 'each_detail_image'>
					<div class='each_detail_pdname'>${dto.product_k_name}</div> <!-- Product_name -->
