			...
			<div class = 'pdcategory_basicImage'>
				...
				<c:forEach var="m" items="${list}">
					<div>
						...
						<a href="eachProduct?ceo_number=${m.ceo_number}&product_number=${m.product_number}"><img src = "resources/img/ceoProductPic/${m.ceo_number}_${m.product_number}_1.png" class='pdcategory_basicImage_img'/></a>
